...
$cadastrar = $_POST["cadastre"];    // Pega o valor do campo Mensagem
...
//            $error = 'Mensagem enviada!';
    ...
    if (smtpmailer('william.aquino@atitude.com.br', 'william.aquino@atitude.com.br', 'Hotel Paraiso', 'Hotel Paraiso',
        $Vai)) {
